...
def measure(&block)
  ...
  print_stats(no_gc, time, gc_stat_after, gc_stat_before, memory_after, memory_before)
end

def print_stats(no_gc, time, gc_stat_after, gc_stat_before, memory_after, memory_before)
  puts "\n"
  puts({
    RUBY_VERSION => {
